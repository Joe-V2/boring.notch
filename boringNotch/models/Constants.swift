...
extension Defaults.Keys {
    ...
    static let liquidGlassBG = Key<Bool>("liquidGlassBG", default: false)
    static let liquidGlassButtonStyle = Key<LiquidGlassStyleEnum>("liquidGlassButtonStyle", default: LiquidGlassStyleEnum.none)
    static let liquidGlassButtonTint = Key<Bool>("liquidGlassButtonTint", default: false)
